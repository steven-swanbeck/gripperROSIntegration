#ifndef _ROS_SERVICE_AddToLog_h
#define _ROS_SERVICE_AddToLog_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char ADDTOLOG[] = "ur_dashboard_msgs/AddToLog";

  class AddToLogRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return ADDTOLOG; };
    virtual const char * getMD5() override { return "5f003d6bcc824cbd51361d66d8e4f76c"; };

  };

  class AddToLogResponse : public ros::Msg
  {
    public:
